...
# dual prompt
python main.py --config=./exps/dualprompt_ina_B0_Inc5.json
python main.py --config=./exps/dualprompt_ina_B0_Inc10.json
python main.py --config=./exps/dualprompt_ina_B0_Inc20.json
python main.py --config=./exps/dualprompt_ina_B100_Inc5.json
python main.py --config=./exps/dualprompt_ina_B100_Inc10.json
# coda prompt
